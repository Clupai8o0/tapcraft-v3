...
const PRODUCTS: { variant: Variant; name: string; sub: string; copy: string; from: string; accent: string; spotlight: string }[] = [
  {
    variant: 'keychain',
    name: 'NFC keychain',
    sub: 'The flagship',
          ...
          {PRODUCTS.map((p, i) => (
            ...
            >
              <SpotlightCard
                ...
                className="tilt overflow-hidden grid grid-cols-1 md:grid-cols-[1.2fr_1fr] gap-0"
              >
